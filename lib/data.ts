import type { Persona, Request, RequestTypeConfig, NetworkNode, CommunityData } from './types';
...
export const requests: Request[] = [
  {
    id: 'r1', unread: true, status: 'pending',
  ...
  },
  {
    ...
    ai: {
      fit: 68,
      reasons: [
        { k: 'topic', v: "Maps to your <strong>published essays</strong> on career tenure." },
        { k: 'signal', v: "Asker has a clear, specific question — higher chance of a good thread." }
      ]
    }
  },
  {
...
export const network: NetworkNode[] = [
  ...
  { id: 'n1', name: 'Sana Ravi', role: 'GP · Index', x: 22, y: 28, score: 94, color: 'purple', initials: 'SR', active: true, why: 'Co-invested in 3 fintech seeds. Leads Series A in your thesis.', overlap: ['Fintech thesis', 'SMB tooling', 'Stripe alumni'] },
  { id: 'n2', name: 'Ben Yoo', role: 'Founder · Pier', x: 72, y: 22, score: 88, color: 'blue', initials: 'BY', active: false, why: 'Building adjacent infra. Looking for design advisors — you fit.', overlap: ['Developer tools', 'Founding team'] },
  { id: 'n3', name: 'Lena Torres', role: 'CFO · Ramp', x: 80, y: 62, score: 81, color: 'pink', initials: 'LT', active: false, why: "Mutual connect through Priya. She's hiring a Head of Platform.", overlap: ['Finance ops', 'SMB GTM'] },
  { id: 'n4', name: 'Kofi Asare', role: 'Writer · Signals', x: 32, y: 74, score: 76, color: 'amber', initials: 'KA', active: false, why: 'Covers your beat. Could profile your thesis for 40k+ readers.', overlap: ['Fintech writing', 'Thought leadership'] },
  { id: 'n5', name: 'Mira Chen', role: 'Ex-Plaid, building', x: 60, y: 78, score: 72, color: 'teal', initials: 'MC', active: false, why: 'Former Plaid PM. Raising pre-seed in compliance tooling.', overlap: ['Fintech', 'Plaid alumni'] },
  { id: 'n6', name: 'Oskar Lind', role: 'GP · Sequence', x: 15, y: 55, score: 64, color: 'slate', initials: 'OL', active: false, why: 'New to SF. Looking to meet operators in fintech.', overlap: ['Fintech', 'SF network'] },
];
