// Onboarding flow + Community admin
function Onboarding({ onDone, persona }) {
        ...
        {step === 1 && (
          <div className="onb-panel">
            <div>
              ...
              <div className="onb-sub">One URL that holds every way someone can reach you. Share it once, on LinkedIn, your bio, your email signature — everything routes here.</div>
            </div>
            <div>
        ...
        {step === 2 && (
          <div className="onb-panel">
            <div>
              ...
              <div className="onb-sub">Pick the request types that match how you want to be reached. Each one gets its own intake form — you'll tune those later.</div>
            </div>
        ...
        {step === 3 && (
          <div className="onb-panel">
            <div>
              ...
              <div className="onb-sub">The model reads your LinkedIn, writing, and accept history to learn your thesis. Toggle what it's allowed to use.</div>
            </div>
        ...
        <div className="leaderboard">
          ...
          {c.leaders.map(l => (
            <div key={l.name} className="leader-row">
              <div className={`leader-rank ${l.rank<=3?'top':''}`}>{l.rank.toString().padStart(2,'0')}</div>
              <Avatar p={{ color: ['amber','blue','green','teal','purple','pink','slate'][l.rank%7], initials: l.name.split(' ').map(x=>x[0]).join('') }} size="sm" />
              <div>
